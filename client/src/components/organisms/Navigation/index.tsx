...
const Navigation = () => {
    ...
    const navLinks = [
        {id: 0, url: '/', text: 'Главная'},
        {id: 1, url: '/blog', text: 'Блог'},
        {id: 2, url: '/communities', text: 'Сообщества'},
        {id: 3, url: '/subscribtions', text: 'Мои подписки'},
        {id: 4, url: '/create', text: 'Создать статью'},
    ];
    return (
        <header className="fixed left-0 top-0 min-w-full">
                ...
                <ul className='hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6'>
                    {
                        navLinks.map(({text, url, id}) =>  {
                            return (
                                <li key={id}>
                                    <Link className={`text-sm font-bold ${url === location ? 'text-black hover:text-gray-800' : 'text-gray-400 hover:text-gray-800'}`} to={url}>{text}</Link>
                                </li>
                            )
                        })
                    }
                    ...
                    {/* <li className='text-gray-300'>
                        <Icon name="navDots" width={24} height={24}/>
                    </li> */}
                </ul>
                <a 
                className='lg:flex align-middle lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200 flex' href='#'>
                    <Icon 
                        name='bell' 
                        width={35} 
                        height={35} 
            ...
            <div className='navbar-menu relative z-50 hidden'>
                ...
                <nav className='fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto'>
                    ...
                    <div className='mt-auto'>
                        <div className='pt-6'>
                            <a className='block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl' href='#'><Icon name='bell' width={20} height={20} /></a>
